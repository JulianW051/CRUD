...
$result = $stmt->fetchAll();
    ...
    foreach ($result as $result){
                ...
                echo            "<td><a href='menu-toevoegen.php?id=" . $result['id'] . "&naam=" . $result['naam'] . "&beschrijving=" . $result['beschrijving'] . "&prijs=" . $result['prijs'] . "&locatie=" . $result['locatie'] . "&eerstePeriode=" . $result['eerstePeriode'] . "&eindPeriode=" . $result['eindPeriode'] . "#gerechtenForm'><button class='update'>Update</button></a></td>";
